...
export default class Lookup extends NavigationMixin(LightningElement) {
    ...
    @api
    reportValidity(){
        return !this.required || this._curSelection.length;
    }
    // INTERNAL FUNCTIONS
    ...
    get isLoading() {
        return this.loading || this._searchThrottlingTimeout != null;
    }
    ...
    handleInputClick(event) {
        ...
        event.stopPropagation(); // evita burbuja
    }

    handleInputMouseDown(event) {
        console.log('mousedown detenido');
        event.stopPropagation(); // evita que el padre cambie el step antes del focus
    }
}